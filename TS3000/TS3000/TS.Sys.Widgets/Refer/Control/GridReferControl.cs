...
{
    public partial class GridReferControl : UserControl
    {
        private Form _form;
        ...
        public GridReferControl()
        {
            InitializeComponent();
        }

        public GridReferControl(Form form, ToolStripButton btn):this()
        {
            _form = form;
            _btn = btn;
        }
        ...
        public void LeavAction(EventArgs e)
        {
            OnLeave(e);
        }
