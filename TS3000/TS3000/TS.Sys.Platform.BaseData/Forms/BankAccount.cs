...
namespace TS.Sys.Platform.BaseData.Forms
{
    public partial class BankAccountForm : Form
    {
        ...
        {
            InitializeComponent();
            this.treeBankAccount.loadTreeDataByTable("银行");
            bankAcctService = new BankAccountService();
        ...
        private void InitGrid()
        {
            ...
            gridBankAccount.Columns["cAccount"].HeaderText = "账户";
        ...
        {
            gridBankAccount.DataSource = bankAcctService.QueryResultByParent(con); 
        }
        ...
        {
            _cCode = treeBankAccount.GetSelectedNode().Name;
        ...
        private void gridBankAccountAccount_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (_refer != null)
            {
