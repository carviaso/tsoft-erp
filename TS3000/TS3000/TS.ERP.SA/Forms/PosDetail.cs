...
namespace TS.ERP.SA
{
    public partial class PosDetailForm : BillTypeForm
    {
        ...
        public PosDetailForm()
        {
                
            InitializeComponent();
            
            new CostTypeReferImpl().setGridDataSource(this.cOrderType, null,null);
        ...
        public PosDetailForm(String action)
            :this()
        {
            InitForm(action);
        ...
        public PosDetailForm(int rowIndex, DataGridViewRowCollection ds)
            : this()
        {
