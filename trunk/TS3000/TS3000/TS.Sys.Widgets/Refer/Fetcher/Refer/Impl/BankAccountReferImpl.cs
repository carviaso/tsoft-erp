...
{
    public class BankAccountReferImpl:BaseRefer 
    {
        /// <summary>
        /// 获取取数SQL
        /// </summary>
        ...
        public override String getSql(String con)
        {
            ...
            String sql = "select rg.cCode,rg.cName from CM_BandAccount rg  " + con;
            return sql;
        }

        public override String getForm()
        {
            return "TS.Sys.Platform.BaseData.Forms.BankAccountForm";
        }

        public override DataFetcher GetDataFetcher()
        {
            return new DataFetcher("CM_BandAccount");
        }
    }
}
